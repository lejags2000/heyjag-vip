...
const NYPD = ({ className = "", propLeft }) => {
  const nYPDStyle = useMemo(() => {
    return {
      left: propLeft,
    };
  }, [propLeft]);
  ...
  return (
    <div
      className={`h-[313px] w-[209px] absolute !m-[0] top-[343px] left-[5px] shrink-0 text-center text-3xs text-white font-body ${className}`}
      style={nYPDStyle}
    >
      <div className="absolute top-[13px] left-[0px] bg-primary w-[195px] h-[300px] overflow-hidden" />
      <div className="absolute top-[0px] left-[14px] bg-white box-border w-[195px] overflow-hidden flex flex-col items-end justify-start pt-0 px-0 pb-3 gap-[10px] z-[1] border-[1px] border-solid border-gray-200">
        <div className="self-stretch h-[150px] relative bg-grey overflow-hidden shrink-0">
          <div className="absolute top-[8px] left-[10px] rounded-sm bg-primary w-[107px] h-[18px] flex flex-row items-start justify-start pt-px px-9 pb-0 box-border whitespace-nowrap">
            <div className="absolute !m-[0] bottom-[-15.5px] left-[4.2px] tracking-[1px] leading-[48px] uppercase font-black inline-block min-w-[98px]">
              1 buy = 1 offer
            </div>
          </div>
          <img
            className="absolute w-[calc(100%_-_18px)] top-[17px] right-[9px] left-[9px] max-w-full overflow-hidden h-[133px] object-cover z-[1]"
            loading="lazy"
            alt=""
            src="/logo-nypd-pizza-2@2x.png"
          />
        </div>
        <div className="self-stretch flex flex-row items-start justify-start pt-0 px-0 pb-[13px] text-left text-black">
          <div className="flex-1 flex flex-col items-start justify-start gap-[8.7px]">
            <div className="flex flex-row items-start justify-start py-0 px-3">
              <div className="relative leading-[12px] font-extrabold">
                Free Large Pizza when you buy one
              </div>
            </div>
            ...
            <div className="self-stretch flex flex-row items-start justify-start py-0 px-3">
              <div className="flex-1 relative leading-[12px]">
                Adress: 308 N Federal Hwy, Boynton Beach, FL 33435
              </div>
            </div>
