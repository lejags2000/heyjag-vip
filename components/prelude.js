...
const Prelude = ({ className = "", propLeft }) => {
  const prelude1Style = useMemo(() => {
    return {
      left: propLeft,
    };
  }, [propLeft]);
  ...
  return (
    <div
      className={`h-[312px] w-[209px] absolute !m-[0] top-[0px] left-[857px] shrink-0 text-center text-3xs text-white font-body ${className}`}
      style={prelude1Style}
    >
      <div className="absolute top-[12px] left-[0px] bg-primary w-[195px] h-[300px] overflow-hidden" />
      <div className="absolute top-[0px] left-[14px] bg-white box-border w-[195px] overflow-hidden flex flex-col items-start justify-start pt-0 px-0 pb-3 gap-[10px] z-[1] border-[1px] border-solid border-gray-200">
        <div className="self-stretch h-[150px] relative bg-grey overflow-hidden shrink-0">
          <div className="absolute top-[8px] left-[10px] rounded-sm bg-primary w-11 h-[18px] flex flex-row items-start justify-start pt-px px-9 pb-0 box-border">
            <div className="absolute !m-[0] bottom-[-15.5px] left-[7.2px] tracking-[1px] leading-[48px] uppercase font-black inline-block min-w-[29px]">
              FREE
            </div>
          </div>
          <img
        ...
        <div className="self-stretch flex flex-col items-end justify-start gap-[17px] text-left text-black">
          <div className="self-stretch flex flex-col items-start justify-start gap-[6.7px]">
